...
//    .epochTime   = 1487576462,
    .password    = "password",
    .ciphertext  = {0xFE, 0xFF, 0xE2, 0x8C, 0x80, 0x00,
...
//    .epochTime   = 1487580093, //0x58AAABBD,
    .password    = "passwordRep",
    .ciphertext  = {0xFE, 0xFF, 0xE2, 0x9A, 0xBF, 0x00,
...
//    .epochTime   = 196127320,
    ...
    .ciphertext  = {0xFE, 0xFF, 0xE2, 0x99, 0xBB, 0x00,
